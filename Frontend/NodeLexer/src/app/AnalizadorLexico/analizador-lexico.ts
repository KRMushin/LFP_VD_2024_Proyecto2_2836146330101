import { GeneradorTokens } from "./generador-tokens";
import { TablaTransiciones } from "./tabla-transiciones";

export class AnalizadorLexico {

    private generadorTokens: GeneradorTokens;
    private estadosAceptacion: string[];
    private delimitadores: string[];
    private delimitadoresNumericos: string[];
    ...
    analizarEntrada(cadena: string): { tokens: any[], listaErrores: any[] } {
        let estadoActual = "q0";
        let tokenActual = "";
        const tokens: any[] = [];
    ...
    recuperarYAnalizarError(cadenaEntrada: string, tokenActual: string, indice: number): { i: number, indicesAvanzados: number, filasAvanzadas: number, lexemaError: string } {
